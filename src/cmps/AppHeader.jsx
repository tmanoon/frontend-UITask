...
export function AppHeader() {
    ...
    return (
        <section className="app-header flex space-between align-center">
            {menuClick && <div className="layout-for-menu"></div>}
            <div className="logo-and-links flex align-center">
                <NavLink to='/'>
                    <svg className="logo-shape" width="160" height="40" viewBox="0 0 160 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="buttons">
                ...
                <span className="hamburger" onClick={(ev) => onMenuClick(ev)}>
            ...
            {menuClick &&
                <div className="hamburger-menu-links grid">
                    <span onClick={(ev) => onMenuClick(ev)}>
