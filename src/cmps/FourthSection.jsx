        ...
        <article className="fourth-desc grid">
            <svg className="bottom-shape" width="200" height="144" viewBox="0 0 200 144" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Group 8">
                    ...
                    <path id="Combined Shape Copy" fillRule="evenodd" clipRule="evenodd" d="M100 244C155.228 244 200 199.228 200 144C200 88.7715 155.228 44 100 44C44.7715 44 0 88.7715 0 144C0 199.228 44.7715 244 100 244ZM100 177C118.225 177 133 162.225 133 144C133 125.775 118.225 111 100 111C81.7746 111 67 125.775 67 144C67 162.225 81.7746 177 100 177Z" fill="#004047" />
                    <path id="Combined Shape" fillRule="evenodd" clipRule="evenodd" d="M100 100H0V104H100V100ZM100 108H0V112H100V108ZM0 116H100V120H0V116ZM100 124H0V128H100V124ZM0 132H100V136H0V132ZM100 140H0V144H100V140Z" fill="#F67E7E" />
            ...
            <div className="title-and-btn flex space-between">
                <h1>Ready to get started?</h1>
                <button className="contact-btn dark">Contact us</button>
            </div>
        </article>
    )
}